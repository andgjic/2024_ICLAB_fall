...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _165498_archive_1.so
_165498_archive_1.so : archive.144/_165498_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_165498_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_165498_archive_1.so $@


ARCHIVE_OBJS += _165515_archive_1.so
_165515_archive_1.so : archive.144/_165515_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_165515_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_165515_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.144/_prev_archive_1.a
	@$(AR) -s $<
